...
function levelAsHtml(level, levelWidth = 24, levelHeight = 24) {
  const spanStyle = `style="width: ${levelWidth}px; height: ${levelHeight}px; display: inline-block; vertical-align: middle;"`;
  switch (level) {
    case 1:
      return `<span
      title="Skill Level 1" ${spanStyle}
    ...
    case 10:
      return `<span
      title="Skill Level 10" ${spanStyle}
      ><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
